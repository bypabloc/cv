...
class ProfileIn(BaseModel):
    """POST /cv-admin operation=content action=upsert-profile.
...
class ExperienceIn(BaseModel):
    """POST /cv-admin operation=content action=upsert-experience.
...
class ProjectIn(BaseModel):
    """POST /cv-admin operation=content action=upsert-project.
...
class SkillCategoryIn(BaseModel):
    """POST /cv-admin operation=content action=upsert-skill-category.
