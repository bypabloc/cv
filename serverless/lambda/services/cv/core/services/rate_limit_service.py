"""Rate-limit service del Lambda `cv` (operations admin).
...
ej. `/cv#content`, `/cv#publish.dispatch`). Las reglas se
...
class RateLimitService:
    ...
    def check_or_raise(
        ...
        *,
        ...
        Args:
            ip: IP del cliente.
            endpoint: identificador `/cv#<operation>[.<action>]`.
        ...
        las operations admin del `cv` son JWT-authed (sin Turnstile); pasar True
