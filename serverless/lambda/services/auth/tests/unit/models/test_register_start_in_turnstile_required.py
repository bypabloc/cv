...
El '' habilita el bypass de Turnstile para tests E2E (dev/local, token
Ed25519 firmado). La exigencia del token NO es a nivel Pydantic sino del
controller register.start, que con cf_response vacio + sin bypass valido
lanza TurnstileError 403 (AC-12, cubierto por
