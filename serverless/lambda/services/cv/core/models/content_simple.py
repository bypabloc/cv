...
class EducationIn(BaseModel):
    """POST /cv operation=content action=upsert-education."""
...
class CertificateIn(BaseModel):
    """POST /cv operation=content action=upsert-certificate."""
...
class AwardIn(BaseModel):
    """POST /cv operation=content action=upsert-award."""
...
class LanguageIn(BaseModel):
    """POST /cv operation=content action=upsert-language."""
...
class EndorsementIn(BaseModel):
    """POST /cv operation=content action=upsert-endorsement."""
...
class PublicationIn(BaseModel):
    """POST /cv operation=content action=upsert-publication."""
...
class DeleteIn(BaseModel):
    """POST /cv operation=content action=delete-<entidad>.
...
class ReorderIn(BaseModel):
    """POST /cv operation=content action=reorder.
...
class CatalogsIn(BaseModel):
    """POST /cv operation=content action=catalogs (sin payload)."""
...
class GetAllIn(BaseModel):
    """POST /cv operation=content action=get-all (sin payload).

    Devuelve el CV completo en shape de edicion (las 10 secciones,
    incluida publications) en UNA sesion Neon.
    """
