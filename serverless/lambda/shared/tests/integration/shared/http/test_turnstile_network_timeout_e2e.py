"""
Given un siteverify que nunca responde (timeout de red),
When verify_turnstile_token valida el token,
Then levanta TurnstileError con code CAPTCHA_TIMEOUT.
"""
...
@mock_aws
@respx.mock
def test_turnstile_network_timeout_e2e() -> None:
    """siteverify con timeout de red -> TurnstileError CAPTCHA_TIMEOUT."""
    # Arrange
    import boto3
