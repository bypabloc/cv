"""Configuracion del Lambda `cv_admin`.
...
SSM publicados por el provisioner. Clona el patron de `users`.
"""
...
class AppConfig(BaseSettings):
    """Configuracion del Lambda `cv_admin`, cargada de env vars + SSM lazy."""
    ...
    # CORS (whitelist CSV — solo los origins del admin)
