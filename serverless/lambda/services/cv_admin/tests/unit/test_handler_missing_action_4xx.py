"""El handler rechaza un body sin action con 4xx.

Given una request con operation=content pero SIN action,
When se invoca lambda_handler,
Then http_handler devuelve 400 (extract_request falla).
"""
...
def test_handler_missing_action_4xx():
