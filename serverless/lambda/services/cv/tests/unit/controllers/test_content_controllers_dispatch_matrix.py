"""Cada controller admin del cv delega en SU service fn (matriz completa).

Given el permiso admin concedido (require_active_user mockeado en el
checker, whitelist real), el rate-limit mockeado y el service fn mockeado,
...
_MATRIX = [
    ...
    (
        'controllers.content.get_all', 'GetAll', {},
        'services.cv_service', 'get_all_admin', {},
    ),
    (
