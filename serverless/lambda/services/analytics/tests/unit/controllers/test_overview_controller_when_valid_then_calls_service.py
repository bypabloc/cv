"""
Given un evento valido de analytics/overview con JWT y service mockeado,
...
from controllers.analytics.overview import Overview


def test_overview_controller_when_valid_then_calls_service(
    mocker, mock_require_auth, mock_check_or_raise
):
    # Arrange
    expected = {'sessions': 10, 'visits': 8, 'events': 50, 'contacts': 1}
    spy = mocker.patch.object(
        analytics_service, 'overview', return_value=expected
    )
    event = {
        'from': '2026-04-27',
        'to': '2026-05-27',
