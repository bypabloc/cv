...
|---|---------------|------|-------------|
| 1 | [Portfolios modernos post-IA](research-modern-portfolios-2026/README.md) | Tendencias generales 2025-2026, ATS, GEO/LLM-SEO, estructura, UX, tecnologias, personal branding | Antes de definir la arquitectura general del portfolio |
| 2 | [Portfolios de desarrolladores + vibe coding](research-developer-portfolios-vibe-coding-2026/README.md) | Especifico para devs: Claude Code/Cursor/Windsurf, GitHub, presencia online, junior/mid/senior post-IA | Al decidir que proyectos, skills y narrativa tecnica mostrar |
| 3 | [Optimizacion para IA / prompt injection](research-ai-prompt-optimization-portfolio-2026/README.md) | White-hat / grey-hat / black-hat para influenciar como las IAs leen tu portfolio. Schema, llms.txt, riesgos eticos | Al implementar metadata y estructura tecnica del sitio |
...
Paso 2: Lee research-modern-portfolios-2026/README.md para entender el marco general
Paso 3: Lee research-developer-portfolios-vibe-coding-2026/README.md para skills/proyectos
Paso 4: Lee research-ai-prompt-optimization-portfolio-2026/README.md para metadata tecnica
...
|----------|--------------------------|------------------------------|
| ¿Que stack uso para construir el portfolio? | [Modern #6 Tecnologias](research-modern-portfolios-2026/06-tecnologias.md) | [Dev #11 Stack/Checklist](research-developer-portfolios-vibe-coding-2026/11-stack-checklist.md) |
| ¿Como paso el filtro de ATS? | [Modern #2 ATS](research-modern-portfolios-2026/02-optimizacion-ats.md) | [AI-Opt #3 White-Hat](research-ai-prompt-optimization-portfolio-2026/03-tecnicas-white-hat.md) |
| ¿Como aparezco en respuestas de ChatGPT/Claude? | [Modern #3 GEO](research-modern-portfolios-2026/03-geo-llm-seo.md) | [AI-Opt #3a JSON-LD](research-ai-prompt-optimization-portfolio-2026/03a-json-ld-schemas.md), [AI-Opt #3c llms.txt](research-ai-prompt-optimization-portfolio-2026/03c-llms-robots-sitemap.md) |
| ¿Que proyectos muestro? | [Dev #4 Proyectos](research-developer-portfolios-vibe-coding-2026/04-proyectos-mostrar.md) | [Modern #4 Estructura](research-modern-portfolios-2026/04-estructura-contenido.md) |
| ¿Como hablo de mi uso de Claude Code? | [Dev #9 Documentacion IA](research-developer-portfolios-vibe-coding-2026/09-documentacion-uso-ia.md) | [Dev #3 Herramientas IA](research-developer-portfolios-vibe-coding-2026/03-herramientas-ia.md) |
| ¿Que NO hacer? | [Modern #9 Anti-patterns](research-modern-portfolios-2026/09-anti-patterns.md) | [AI-Opt #5 Black-Hat](research-ai-prompt-optimization-portfolio-2026/05-tecnicas-black-hat.md), [AI-Opt #7 Riesgos](research-ai-prompt-optimization-portfolio-2026/07-deteccion-riesgos.md) |
| ¿Que diferencia junior/mid/senior 2026? | [Dev #8 Niveles](research-developer-portfolios-vibe-coding-2026/08-niveles-junior-mid-senior.md) | [Dev #2 Reclutadores](research-developer-portfolios-vibe-coding-2026/02-reclutadores-tech.md) |
