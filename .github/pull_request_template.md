...
<!--
Que problema resuelve este PR. Conciso. Si son varios, enumerar 1., 2., 3.
...
<!--
Pasos reproducibles que cualquier reviewer pueda seguir. NO "lo probe local".
Incluir:
  - URLs de preview deploy si las hay
  - Comandos para correr local (`pnpm run dev`, `docker compose up`, etc.)
