/**
 * @module rooms/past/aula (engine)
 * @description El "antes" del aula: Pablo PRE-uni (decision del usuario:
 *   NO tocar su contenido). Kihon de karate contra el makiwara, el amigo
 *   gamer con GTA San Andreas corriendo (la pregunta que desperto todo) y
 *   el trabajo de tecnico de aires acondicionados que pagaba la
 *   universidad — con la unidad encendible/apagable con E.
 */
import {
  CanvasTexture,
  Group,
...
import { chair, desk, footprint } from '../props'
import { PAST_SCREEN, type PastSet } from './shared'
