"""Admin authz guard del Lambda `cv_admin`.
...
existencia del endpoint, anti-enumeration). TODAS las actions de cv_admin
...
def require_admin_user(
    ...
    *,
    ip: str | None = None,
    audit_action: str = 'cv-admin.access',
) -> None:
    ...
    try:
        ...
        logger.warning(
            'cv_admin: acceso denegado (no-admin)',
            extra={
