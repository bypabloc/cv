"""
Given un evento valido de contacts/list con paginacion, filtros y JWT,
...
def test_contacts_list_controller_when_valid_then_passes_pagination(
    ...
    spy = mocker.patch.object(contacts_service, 'list', return_value=expected)
    event = {
        'from': '2026-04-27',
        'to': '2026-05-27',
        'page': 2,
